...
class UpcomingOrganizerEventListAdapter(
    private var mContext:Context,
    private var eventDashboardCategory: List<EventByOrganizerResponse.EventByOrganizer>,
    ) : RecyclerView.Adapter<UpcomingOrganizerEventListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemUpcomingEventsBinding, val mContext: Context) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(eventDashboard_Category: List<EventByOrganizerResponse.EventByOrganizer>, position: Int) {
