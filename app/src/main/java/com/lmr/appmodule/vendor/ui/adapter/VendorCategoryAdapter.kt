...
class VendorCategoryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBinding = DataBindingUtil.inflate<AdapterVendorCategoryItemBinding>(
            LayoutInflater.from(parent.context),
            R.layout.adapter_vendor_category_item, parent, false)
